...
import com.health.pusun.device.EggPlayActivity;
...
public class NextGroupActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_next_group);
        ...
        (new Handler()).postDelayed(new Runnable() {
            ...
            public synchronized void run() {
                Glide.with(NextGroupActivity.this).load(R.drawable.gif5).into(load_gif);
                SelectModeMsg selectMsg = new SelectModeMsg();
...
//                Glide.with(CountDownActivity.this).load(R.drawable.gif0).into(load_gif);
        ...
        (new Handler()).postDelayed(new Runnable() {
            @Override
            public synchronized void run() {
                if(type == 9999) startActivity(new Intent(NextGroupActivity.this, EggPlayActivity.class));
                else{
                    Intent intent = new Intent(NextGroupActivity.this, VideoPlayActivity.class);

...
import com.health.pusun.device.MainActivity;
...
public class ModeCategaryAdapter extends FragmentPagerAdapter {

    private Context mContext;
    private final int PAGER_COUNT = 2;
    private List<Fragment> fragments;

    public ModeCategaryAdapter(Context context, FragmentManager fm, List<Fragment> fragments) {
        super(fm);
    ...
    public Fragment getItem(int position) {
        ...
        switch (position) {
            ...
            case ModeSelectActivity.PAGE_TWO:
                ...
                break;
//
//            case ModeSelectActivity.PAGE_THREE:
